...
export default function Koyya() {
    ...
    return (
        <div
            ...
            {/* Header */}
            <div>
                <h1 className='text-white text-7xl text-center font-bold mt-30 '>Koyya</h1>
                <p className="text-white text-center mt-4 text-xl max-w-xl mx-auto ">
                    <p className="text-white text-center mt-4 text-xl max-w-xl mx-auto ">
                        Koyya.in is a dual-vertical platform offering tech solutions and agribusiness services.                    </p>
                </p>
            </div>
            ...
            <div className=' text-2xl max-w-8xl mx-auto text-white mb-10'>
                ...
                <p>Koyya.in is a dual-vertical website that showcases both technology solutions (web, mobile, IoT) and agribusiness offerings (coffee products, marketing services).
                    Designed for tech clients, agri buyers, and investors, the platform delivers a clean, professional, and responsive user experience. Backed by research and user personas,
                    it features clear navigation, dual branding, and visual storytelling. Key sections include landing, about, services, careers, and contact pages. Upcoming enhancements
                    include e-commerce integration, multilingual support, and personalized user experiences to boost engagement and conversions.</p>
            </div>
